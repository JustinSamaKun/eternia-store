...
export async function loader({ request }: LoaderFunctionArgs) {
    ...
    const [featured, top, favorites] = await Promise.all([
        await client.fetchProductsByTag('slideshow'),
        await client.fetchPopularItems(15),
        await client.fetchPopularItems(15, undefined, cartId)
    ])
        ...
        <>
            ...
            <div className={"flex flex-row gap-2"}>
                ...
                <div className={"flex flex-row justify-between items-center"}>
                    {shop.categories
                        .flatMap(c => c.subcategories ? c.subcategories : [c])
                        .slice(0, 3)
                        .map(c => (
