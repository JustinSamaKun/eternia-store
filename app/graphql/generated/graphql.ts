...
export type ShopQuery = { __typename?: 'Query', shop: { __typename?: 'Shop', id: string, title: string, description: string, theme: { __typename?: 'Theme', variables: Array<{ __typename?: 'Entry', key: string, value: string }> }, branding: { __typename?: 'Branding', logo?: string | null, icon?: string | null }, categories: Array<{ __typename?: 'Category', id: string, title: string, handle: string, order: number, subcategories: Array<{ __typename?: 'Category', id: string, title: string, handle: string, order: number }> }> } };
